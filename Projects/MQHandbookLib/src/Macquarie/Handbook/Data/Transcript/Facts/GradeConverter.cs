...
//TODO Consider converting to a parser instead with Parse(...) and TryParse(...) methods.
...
public static class GradeConverter
{
    ...
    public static EnumGrade ConvertStringToGrade(string str) {
        return str switch
        {
            "P"  => EnumGrade.Pass,
            "CR" => EnumGrade.Credit,
            "D"  => EnumGrade.Distinction,
            "HD" => EnumGrade.HighDistinction,
            _    => EnumGrade.Fail
        };
    }
}
